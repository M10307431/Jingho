...
Keyfob="\x8C\x64\xAB\x29\x6A\xBC"
...
if __name__ == "__main__":
    ...
    try:
        '''
        print "Time",Timeslot
        count=  Timeslot/(Nodeinfo[0][0])+Timeslot/(Nodeinfo[0][1])+ Timeslot/(Nodeinfo[1][0])+Timeslot/(Nodeinfo[1][1])+Timeslot/(Nodeinfo[2][0])+Timeslot/(Nodeinfo[2][1])
        print "count:",count

        Anothercount=float(Nodeinfo[3]["meet"]+Nodeinfo[3]["miss"])
